...
<tbody>
          <tr>
        <th>
  <label style="color:black;" for="fname">Account Number of Reciever:</label><br>
...
<span class="error" style="color:red;"> <?php echo $account_error;?></span></br>
  ...
  <label style="color:black;" for="fname">Name of Reciever:</label><br>
  ...
  <label style="color:black;" for="fname">Sum to be transfer:</label><br>
