 ...
 $result = $conn->query($sql) or die($conn->error);
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
										<a href='#edit_".$row['customerCode']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
										<a href='#delete_".$row['customerCode']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									</td>
								</tr>";
