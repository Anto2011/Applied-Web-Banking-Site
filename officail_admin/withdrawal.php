  ...
  $transaction_error="";
   ...
   //number validation
        ...
        else
        {
         ...
         if(empty($_POST["sum"])){
      $amount_error= "sum to be transfer is required";
       }else{
      $sum = cleanup_data($_POST["sum"]);
        ...
        if ($amount_error=="" && $amount_error==""){
              ...
              if($count2 > 0){
                      ...
                      if ($ordinaryDeposit < $sum ){
                        $transaction_error ="Dont have enought money to Withdraw sum";
                      }
                      else
                      {
                      ...
                      $date=Date("Y/m/d");
                      $description= "Withdraw  $sum from Bank";
                        ...
                        $stmt = null;
                      $transaction_error2 =" Transaction was sucessful Withdraw $sum to ordinaryDeposit ";
                      }
              }else
                          {
...
<div class="btn-group">
  ...
  <a href="#"><button>Withdrawal</button></a>
...
<div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Withdrawal</h2>
            <p>Withdraw money from a customer's account by entering their account no. and the sum of money.</p>
            <form action="" class="templatemo-login-form" method="post">
              <div class="row form-group">
                ...
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">Amount To Withdraw:</label>
              ...
              <div class="form-group text-right">
                <div class="templatemo-white-action">
                  <button type="submit" class="templatemo-white-button">Complete Withdrawal</button>
