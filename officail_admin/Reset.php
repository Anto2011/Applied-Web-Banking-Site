            ...
            echo $accountNumber;
              ...
              if($count2 > 0){
                echo "count 2";
                      ...
                      if($attempts>0){
                        $transaction_error2 =" The user $userName is already unblocked ";
                      }
                      else{
                      $attempts = 3;
                      ...
                      $transaction_error2 =" The user $userName has been unblocked ";
                      }
                    }else
                          {
...
<div class="btn-group">
  ...
  <a href="#"><button>Reset Account</button></a>
...
<div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Reset User</h2>
            <p>Reset a user's account password by verifying their account no.</p>
            <form action="" class="templatemo-login-form" method="post">
              ...
              <div class="form-group text-right">
                <div class="templatemo-white-action">
                  <button type="submit" class="templatemo-white-button">Reset Account</button>
